...
# level %in% c("lv1", "lv2", "lv3", "lv4", "lv5", "lv6")
# param %in% c("param_lv1_concept", param_lv2_specs, param_lv3_FF, param_lv4_ACH, param_lv5_Fan, param_lv6_ACMV)
...
# end_use_combines <- rbind(lv1_end_use_dt, lv2_end_use_dt, lv3_end_use_dt)
...
# ------------------------------------------------------------------------------
# Combine the suplenmental simulation results with old simulation results
...
ggsave(filename = here::here("data","revision", "V2", "ECM_ranking_AC.jpg"), 
...
ggsave(filename = here::here("data","revision", "V2", "ECM_ranking_MM.jpg"), 
...
p_bar_ECM_savings <- ggplot(best_ecm_type[mode=="AC",], aes(x=Levels, y=`Estimated energy savings [kWh]`, fill=ECM_type)) +
  ...
  labs(x = "Levels", y = "Estimated energy savings [kWh]") +
...
ggsave(filename = here::here("data","revision", "V2", "ECM_savings_AC.jpg"), 
...
ggsave(filename = here::here("data","revision", "V2", "ECM_savings_all.jpg"), 
...
ggsave(filename = here::here("data","revision", "V2","savings_diff_percentage_AC.jpg"), 
